	  ...
	  <div class="panel-body">
	   <form id="taskForm" target="uploadFileIFrame" class="form" action="file/upload" method="post" enctype="multipart/form-data">
	    <div class="form-group">
	      ...
	      <div class="radio">
	        <label>
	          <input type="radio" name="way" id="way1" value="redo" checked><span>再次申请</span>
	        </label>
	      </div>
	      <div class="radio">
	        <label>
	          <input type="radio" name="way" id="way2" value="undo"><span>取消申请</span>
	        </label>
	      </div>
...
var sub =function(){
	...
	var decisionInfo=$("input[name='way']:checked").next("span").html();
